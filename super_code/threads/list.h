...
class List {
  public:
    ...
    //Agregados para ejerc. 2 (plancha 3)
    Item ItemPrio(int keyPtr);
    Item RemoveItemPrio(int keyPtr);

    //Agregado para ejercicio 4 plancha 2
    bool IndexRemove(Item i);
...
//Agregado para el ejercicio 4 (plancha 2)
template <class Item>
bool
List<Item>::IndexRemove(Item i)
{
  ListElement<Item> *aux;
...
//No elimina el item que retorna
template <class Item>
Item
List<Item>::ItemPrio(int keyPtr)
{
  ListNode *ptr;
...
//Elimina el item que retorna
template <class Item>
Item
List<Item>::RemoveItemPrio(int keyPtr)
{
  ListElement<Item> *aux;
